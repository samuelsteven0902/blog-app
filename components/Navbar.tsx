          ...
          {session && session?.user ? (
            ...
            >
              <div className="flex items-center justify-center  dark:bg-gray-700">
                <button type="submit" className="flex items-center bg-white dark:bg-gray-900 border border-gray-300 rounded-lg shadow-md px-6 py-2 text-sm font-semibold text-gray-800 dark:text-white hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
